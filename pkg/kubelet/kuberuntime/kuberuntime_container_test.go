...
func TestKillContainer(t *testing.T) {
	...
	for _, test := range tests {
		err := m.killContainer(nil, test.pod, test.containerID, test.containerName, test.reason, &test.gracePeriodOverride)
...
func TestLifeCycleHook(t *testing.T) {
	...
	t.Run("PreStop-CMDExec", func(t *testing.T) {
		...
		m.killContainer(nil, testPod, cID, "foo", "testKill", &gracePeriod)
	...
	t.Run("PreStop-NoTimeToRun", func(t *testing.T) {
		...
		m.killContainer(nil, testPod, cID, "foo", "testKill", &gracePeriodLocal)
