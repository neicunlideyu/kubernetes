...
type reporterOptions struct {
	...
	// periodicFlushSupport enables periodic flush of unfinished spans of a reporter if it support.
	periodicFlushSupport bool
...
// PeriodicFlushSupport creates a ReporterOption that sets how often the pending unfinished
// spans are flushed.
func (reporterOptions) PeriodicFlushSupport(periodicFlushSupport bool) ReporterOption {
	return func(r *reporterOptions) {
		r.periodicFlushSupport = periodicFlushSupport
	}
}
