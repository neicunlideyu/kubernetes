...
type ReporterConfig struct {
	...
	// PeriodicFlushSupport, when true, enables periodic flush of unfinished spans of a reporter
...
func (rc *ReporterConfig) NewReporter(
	...
	reporter := jaeger.NewRemoteReporter(
		...
		jaeger.ReporterOptions.PeriodicFlushSupport(rc.PeriodicFlushSupport))
